...
- id: REA-06#3
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_outputs/artifact_01_rea_with_injections__reg_for_injectiontest_reranked/chunk6_deontic_stages/rea-06#3.json
- used_reg_ids: REG-004, REG-031, REG-094
...
manner: use cookies, embed additional third-party tracking, and monitor
...
- id: REG-002
  ...
  hop_count: 2
  relation_path: REG-004 <- REG-001 -> REG-002
...
- id: REG-003
  ...
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-004 <- REG-001 -> REG-003
...
- id: REG-005
  ...
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-004 <- REG-001 -> REG-005
...
- id: REG-006
  ...
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-004 <- REG-001 -> REG-006
...
- id: REG-007
  ...
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-004 <- REG-001 -> REG-007
