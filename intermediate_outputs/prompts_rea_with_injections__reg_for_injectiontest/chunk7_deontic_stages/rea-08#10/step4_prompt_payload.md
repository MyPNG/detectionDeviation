...
- id: REA-08#10
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_outputs/artifact_01_rea_with_injections__reg_for_injectiontest_reranked/chunk7_deontic_stages/rea-08#10.json
- used_reg_ids: REG-083, REG-066, REG-104
...
- id: REG-063
  ...
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-066 <- REG-062 -> REG-063
  text: "In addition to the information referred to in paragraph 1, the controller shall, at the time when personal data are obtained, provide the data subject with the following further information necessary to ensure fair and transparent processing: (a) the period for which the personal data will be stored, or if that is not possible, the criteria used to determine that period;"
- id: REG-064
  edge_type: PARENT_CHILD
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-066 <- REG-062 -> REG-064
...
- id: REG-065
  ...
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-066 <- REG-062 -> REG-065
...
- id: REG-098
  ...
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-104 <- REG-097 -> REG-098
...
- id: REG-099
  ...
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-104 <- REG-097 -> REG-099
