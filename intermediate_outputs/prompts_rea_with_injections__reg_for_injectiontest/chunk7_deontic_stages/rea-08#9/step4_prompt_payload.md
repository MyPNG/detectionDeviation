...
- id: REA-08#9
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_outputs/artifact_01_rea_with_injections__reg_for_injectiontest_reranked/chunk7_deontic_stages/rea-08#9.json
- used_reg_ids: REG-094, REG-083, REG-121
...
- id: REG-079
  ...
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-083 <- REG-078 -> REG-079
...
- id: REG-080
  ...
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-083 <- REG-078 -> REG-080
...
- id: REG-081
  ...
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-083 <- REG-078 -> REG-081
...
- id: REG-082
  ...
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-083 <- REG-078 -> REG-082
...
- id: REG-084
  ...
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-083 <- REG-078 -> REG-084
...
- id: REG-085
  ...
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-083 <- REG-078 -> REG-085
...
- id: REG-114
  ...
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-121 <- REG-113 -> REG-114
  text: "The data subject shall have the right to obtain from the controller the erasure of personal data concerning him or her without undue delay"
- id: REG-115
  edge_type: PARENT_CHILD
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-121 <- REG-113 -> REG-115
...
- id: REG-116
  ...
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-121 <- REG-113 -> REG-116
  text: "The data subject shall have the right to obtain from the controller the erasure of personal data concerning him or her without undue delay"
- id: REG-117
  edge_type: PARENT_CHILD
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-121 <- REG-113 -> REG-117
...
- id: REG-118
  ...
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-121 <- REG-113 -> REG-118
  text: "The data subject shall have the right to obtain from the controller the erasure of personal data concerning him or her without undue delay"
- id: REG-119
  edge_type: PARENT_CHILD
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-121 <- REG-113 -> REG-119
  text: "and the controller shall have the obligation to erase personal data without undue delay where one of the following grounds applies: (c) the data subject objects to the processing pursuant to Article 21(1) and there are no overriding legitimate grounds for the processing, or the data subject objects to the processing pursuant to Article 21(2);"
- id: REG-122
  edge_type: PARENT_CHILD
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-121 <- REG-113 -> REG-122
  text: "The data subject shall have the right to obtain from the controller the erasure of personal data concerning him or her without undue delay"
- id: REG-123
  edge_type: PARENT_CHILD
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-121 <- REG-113 -> REG-123
...
- id: REG-124
  ...
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-121 <- REG-113 -> REG-124
  text: "The data subject shall have the right to obtain from the controller the erasure of personal data concerning him or her without undue delay"
- id: REG-125
  edge_type: PARENT_CHILD
  direction: via_parent_outgoing
  hop_count: 2
  relation_path: REG-121 <- REG-113 -> REG-125
