...
MODAL_RULES = _load_modal_rules(Path(__file__).resolve().parents[4] / "rules" / "modal_force_rules.txt")
...
def main() -> None:
    ...
    input_json = project_root / "input" / reg_input_name / "gdpr.json"
    output_main_json = (
        project_root
        ...
        / reg_input_name
        / f"{reg_input_name}_requirements.json"
    )
    output_extended_json = (
        project_root
        / "intermediate_results"
        / "01_preprocessing"
        / "reg_prep"
