...
class RequirementsGraphBuilder:
    ...
    def build_graph(self) -> nx.DiGraph:
        ...
        for item in requirements:
            ...
            self.graph.add_edge(provision_id, article_id, relation="BELONGS_TO")
        ...
        for item in requirements:
            ...
            for raw_ref in references:
                ...
                self.graph.add_edge(source_id, article_target, relation="REFERENCES")
...
def main() -> None:
    ...
    output_graphml = input_json.parent / "eu_ai_requirements_graph.graphml"
    output_json = input_json.parent / "eu_ai_requirements_graph.json"
