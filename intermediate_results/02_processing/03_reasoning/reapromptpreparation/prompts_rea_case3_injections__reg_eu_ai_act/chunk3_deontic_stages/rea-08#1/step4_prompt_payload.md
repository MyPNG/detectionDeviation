...
- id: REA-08#1
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea_case3_injections__reg_eu_ai_act_reranked/chunk3_deontic_stages/rea-08#1.json
- used_reg_ids: REG-017, REG-085, REG-015
...
REA FOCUS UNIT
id: REA-08#1
text: "Document the pre-release results of the evaluations."
slots:
actor: 
modal: Mandatory
action: document
actions: document
object: the pre - release results of the evaluations
temporal: 
condition: 
manner: 
...
3. REG-015
clause: Art9(6)
text: "Testing shall ensure that high-risk AI systems perform consistently for their intended purpose and that they are in compliance with the requirements set out in this Section."
slots:
actor: Testing
modal: Mandatory
action: ensure
actions: ensure
object: that high-risk AI systems perform consistently for their intended purpose and that they are in compliance with the requirements set out in this Section.
temporal: 
condition: and that they are in compliance with the requirements set out in this Section
manner: 

REQUIRED REG IDS
REG-017, REG-085, REG-015
