...
- id: REA-10#1
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea_case3_injections__reg_eu_ai_act_reranked/chunk3_deontic_stages/rea-10#1.json
- used_reg_ids: REG-060, REG-056, REG-048
...
REA FOCUS UNIT
id: REA-10#1
text: "Provide documentation to customers which describes the system's: 2) evidence that the system is fit for purpose for each intended use."
slots:
actor: Provider
modal: Mandatory
action: provide
actions: provide
object: documentation to customers which describes the system 's : 2 ) evidence that the system is fit for purpose for each intended use
temporal: 
condition: describes the system's: 2) evidence that the system is fit for purpose for each intended use
manner: 

MAIN REG MATCHES
1. REG-060
clause: Art13(6(v))
text: "(iv) where applicable, The Provider shall provide information that is relevant to explain its output; (v) when appropriate, The Provider shall perform regarding specific persons or groups of persons on which the system is intended to be used;"
slots:
actor: The Provider
modal: Mandatory
action: provide
actions: provide
object: information that is relevant to explain its output; (v) when appropriate, The Provider shall perform regarding specific persons or groups of persons on which the system is intended to be used;
...
2. REG-056
clause: Art13(3(i))
text: "The instructions for use shall contain least the following information: (i) its intended purpose;"
slots:
actor: The instructions for use
modal: Mandatory
action: contain
actions: contain
object: least the following information: (i) its intended purpose;
temporal: following information
condition: its intended purpose
manner: 
