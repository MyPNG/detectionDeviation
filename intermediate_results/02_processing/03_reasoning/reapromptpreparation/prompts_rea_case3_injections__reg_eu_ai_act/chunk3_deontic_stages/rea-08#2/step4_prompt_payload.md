...
- id: REA-08#2
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea_case3_injections__reg_eu_ai_act_reranked/chunk3_deontic_stages/rea-08#2.json
- used_reg_ids: REG-032, REG-023, REG-015
...
REA FOCUS UNIT
id: REA-08#2
text: "Evaluations are conducted primarily via informal peer-review discussions rather than documented metric-based testing. (No change needed)"
slots:
actor: Evaluations
modal: 
action: conduct
actions: conduct
object: informal peer - review discussions
temporal: 
condition: 
manner: via informal peer-review discussions rather than documented metric-based testing
