...
- id: REA-10#2
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea_case3_injections__reg_eu_ai_act_reranked/chunk3_deontic_stages/rea-10#2.json
- used_reg_ids: REG-051, REG-050, REG-048
...
REA FOCUS UNIT
id: REA-10#2
text: "Instead of providing a detailed Transparency Note for platform services, provide only a verbal summary to the customer's procurement lead."
slots:
actor: Provider
modal: Mandatory
action: provide
actions: provide
object: a detailed Transparency Note for platform services
temporal: 
condition: 
manner: 
...
1. REG-051
clause: Art13(1)
text: "deployer An appropriate type and degree of transparency shall be ensured with a view to achieving compliance with the relevant obligations of the provider and deployer set out in Section 3."
slots:
actor: deployer An appropriate type and degree of transparency
modal: Mandatory
action: ensured
actions: ensured
object: with a view to achieving compliance with the relevant obligations of the provider and deployer set out in Section 3.
temporal: 
condition: 
manner: with a view to achieving compliance with the relevant obligations of the provider and deployer set out in Section 3

2. REG-050
clause: Art13(1)
text: "deployer High-risk AI systems shall be designed and developed in such a way as to ensure that their operation is sufficiently transparent to enable deployers to interpret a system's output and use it appropriately."
slots:
actor: deployer High-risk AI systems
modal: Mandatory
action: designed
actions: designed
object: and developed in such a way as to ensure that their operation is sufficiently transparent to enable deployers to interpret a system's output and use it appropriately.
temporal: 
condition: 
manner: sufficiently transparent

3. REG-048
clause: Art11(2)
text: "The Provider SHALL draw up a single set of technical documentation containing all the information set out in paragraph 1, as well as the information required under those legal acts where a high-risk ai system related to a product covered by the union harmonisation legislation listed in section a of annex i is placed on the market or put into service."
slots:
actor: The Provider
modal: Mandatory
action: draw
actions: draw
object: up a single set of technical documentation containing all the information set out in paragraph 1, as well as the information required under those legal acts where a high-risk ai system related to a product covered by the union harmonisation legislation listed in section a of annex i is placed on the market or put into service.
temporal: by the union harmonisation legislation listed
condition: where a high-risk ai system related to a product covered by the union harmonisation legislation listed in section a of annex i is placed on the market or put into service
manner: by the union harmonisation legislation listed in section a of annex i is placed on the market or put into service

REQUIRED REG IDS
REG-051, REG-050, REG-048
