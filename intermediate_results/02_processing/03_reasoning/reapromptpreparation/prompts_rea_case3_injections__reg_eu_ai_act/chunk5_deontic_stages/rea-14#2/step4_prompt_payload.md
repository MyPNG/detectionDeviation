...
- id: REA-14#2
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea_case3_injections__reg_eu_ai_act_reranked/chunk5_deontic_stages/rea-14#2.json
- used_reg_ids: REG-072, REG-074, REG-070
...
REA FOCUS UNIT
id: REA-14#2
text: "The ultimate responsibility for oversight and risk mitigation lies solely with the end-user's IT department rather than the system provider."
slots:
actor: The ultimate responsibility for oversight and risk mitigation
modal: Prohibited
action: lie
actions: lie
object: oversight and risk mitigation
temporal: 
condition: 
manner: 
