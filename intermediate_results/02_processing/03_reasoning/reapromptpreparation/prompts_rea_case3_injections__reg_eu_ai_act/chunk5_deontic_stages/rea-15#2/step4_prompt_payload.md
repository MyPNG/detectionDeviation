...
- id: REA-15#2
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea_case3_injections__reg_eu_ai_act_reranked/chunk5_deontic_stages/rea-15#2.json
- used_reg_ids: REG-071, REG-070, REG-085
...
REA FOCUS UNIT
id: REA-15#2
text: "Metrics or rubrics SHALL be included that will be used in the evaluations. When this is not possible, guidance SHALL be provided to the third party responsible for evaluating oversight or control functions."
slots:
actor: Metrics or rubrics
modal: Mandatory(shall)
action: included
actions: included
object: that will be used in the evaluations. When this is not possible, guidance SHALL be provided to the third party responsible for evaluating oversight or control functions.
temporal: 
condition: When this is not possible
manner: 

MAIN REG MATCHES
1. REG-071
clause: Art14(3)
text: "The oversight measures shall be ensured through either one or both of the following types of measures:."
slots:
actor: The oversight measures
modal: 
action: ensured
actions: ensured
object: through either one or both of the following types of measures:.
temporal: following types of measures
condition: 
manner: through either one or both of the following types of measures:

2. REG-070
clause: Art14(3)
text: "The oversight measures shall be commensurate with the risks, level of autonomy and context of use of the high-risk AI system,"
slots:
actor: The oversight measures
modal: 
action: be commensurate
actions: be commensurate
object: with the risks, level of autonomy and context of use of the high-risk AI system,
temporal: 
condition: 
manner: 
