...
- id: REA-15#1
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea_case3_injections__reg_eu_ai_act_reranked/chunk5_deontic_stages/rea-15#1.json
- used_reg_ids: REG-071, REG-072, REG-074
...
REA FOCUS UNIT
id: REA-15#1
text: "The method SHALL be defined and documented to evaluate whether each oversight or control function can be accomplished by stakeholders in realistic conditions of system use."
slots:
actor: The method
modal: Mandatory(shall)
action: defined
actions: defined
object: and documented to evaluate whether each oversight or control function can be accomplished by stakeholders in realistic conditions of system use.
temporal: by stakeholders in realistic conditions of
condition: 
manner: by stakeholders in realistic conditions of system use
