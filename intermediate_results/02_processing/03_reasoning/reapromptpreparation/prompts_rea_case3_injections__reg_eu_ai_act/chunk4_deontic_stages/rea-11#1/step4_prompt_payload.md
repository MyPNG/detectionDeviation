...
- id: REA-11#1
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea_case3_injections__reg_eu_ai_act_reranked/chunk4_deontic_stages/rea-11#1.json
- used_reg_ids: REG-036, REG-028, REG-033
...
REA FOCUS UNIT
id: REA-11#1
text: "The Stakeholders SHALL define and document data requirements with respect to the system's intended uses, stakeholders, and the geographic areas where the system will be deployed."
slots:
actor: The Stakeholders
modal: Mandatory(shall)
action: define
actions: define | document
object: and document data requirements with respect to the system's intended uses, stakeholders, and the geographic areas where the system will be deployed.
temporal: 
condition: where the system will be deployed
manner: with respect to the system's intended uses, stakeholders, and the geographic areas where the system will be deployed

MAIN REG MATCHES
1. REG-036
clause: Art10(4)
text: "Data sets shall take into account, to the extent required by the intended purpose, the characteristics or elements that are particular to the specific geographical, contextual, behavioural or functional setting within which the high-risk AI system is intended to be used."
slots:
actor: Data sets
modal: Mandatory
action: take
actions: take
object: into account, to the extent required by the intended purpose, the characteristics or elements that are particular to the specific geographical, contextual, behavioural or functional setting within which the high-risk AI system is intended to be used.
temporal: within which the high-risk AI system
condition: 
manner: by the intended purpose

2. REG-028
clause: Art10(2(e))
text: "Those practices shall concern in particular: (e) an assessment of the availability, quantity and suitability of the data sets that are needed;"
slots:
actor: Those practices
modal: Mandatory
action: concern
actions: concern
object: in particular: (e) an assessment of the availability, quantity and suitability of the data sets that are needed;
temporal: 
condition: 
manner: 
...
slots:
actor: validation and testing data sets
modal: Mandatory
action: be relevant
actions: be relevant
object: sufficiently representative, and to the best extent possible, free of errors and complete in view of the intended purpose.
temporal: 
condition: 
manner: 

REQUIRED REG IDS
REG-036, REG-028, REG-033
