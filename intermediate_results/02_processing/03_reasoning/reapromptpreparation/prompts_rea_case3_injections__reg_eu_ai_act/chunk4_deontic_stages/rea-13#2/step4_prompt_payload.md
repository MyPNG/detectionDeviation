...
- id: REA-13#2
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea_case3_injections__reg_eu_ai_act_reranked/chunk4_deontic_stages/rea-13#2.json
- used_reg_ids: REG-028, REG-019, REG-085
...
REA FOCUS UNIT
id: REA-13#2
text: "Document this assessment in the Impact Assessment."
slots:
actor: User
modal: Mandatory
action: document
actions: 
object: this assessment in the Impact Assessment
temporal: 
condition: 
manner: 
...
3. REG-085
clause: Art15(3)
text: "The Regulator SHALL declare the levels of accuracy and the relevant accuracy metrics of high-risk AI systems in the accompanying instructions of use."
slots:
actor: The Regulator
modal: Mandatory
action: declare
actions: declare
object: the levels of accuracy and the relevant accuracy metrics of high-risk AI systems in the accompanying instructions of use.
temporal: 
condition: 
manner: 

REQUIRED REG IDS
REG-028, REG-019, REG-085
