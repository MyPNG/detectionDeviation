...
- id: REA-01#3
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea_case3_injections__reg_eu_ai_act_reranked/chunk1_deontic_stages/rea-01#3.json
- used_reg_ids: REG-032, REG-023, REG-016
...
REA FOCUS UNIT
id: REA-01#3
text: "Assess the impact of the system on people, organizations, and society by completing an Impact Assessment early in the system's development, typically when defining the product vision and requirements."
slots:
actor: 
modal: Mandatory
action: assess
actions: assess
object: the impact of the system on people , organizations , and society
...
3. REG-016
clause: Art9(7)
text: "Testing procedures may include testing in real-world conditions in accordance with Article 60."
slots:
actor: Testing procedures
modal: Permissive
action: include
actions: include
object: testing in real-world conditions in accordance with Article 60.
temporal: 
condition: in accordance with Article 60
manner: in accordance with Article 60

REQUIRED REG IDS
REG-032, REG-023, REG-016
