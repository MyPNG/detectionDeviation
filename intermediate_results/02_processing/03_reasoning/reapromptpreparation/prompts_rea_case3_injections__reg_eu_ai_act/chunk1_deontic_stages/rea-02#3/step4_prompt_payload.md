...
- id: REA-02#3
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea_case3_injections__reg_eu_ai_act_reranked/chunk1_deontic_stages/rea-02#3.json
- used_reg_ids: REG-032, REG-021, REG-067
...
REA FOCUS UNIT
id: REA-02#3
text: "Review the completed Impact Assessment with the reviewers identified according to your organization's compliance process before development starts."
slots:
actor: 
modal: Mandatory
action: review
actions: review
object: the completed Impact Assessment
temporal: before development starts
condition: before development starts
manner: with the reviewers identified according to your organization's compliance process
...
2. REG-021
clause: Art10(1)
text: "The Developer SHALL develop high-risk AI systems which make use of techniques involving the training of AI models with data on the basis of training, validation and testing data sets that meet the quality criteria referred to in paragraphs 2 to 5 whenever such data sets are used."
slots:
actor: The Developer
modal: Mandatory
action: develop
actions: develop
object: high-risk AI systems which make use of techniques involving the training of AI models with data on the basis of training, validation and testing data sets that meet the quality criteria referred to in paragraphs 2 to 5 whenever such data sets are used.
temporal: whenever such data sets are used
condition: 
manner: 

3. REG-067
clause: Art14(1)
text: "The Provider SHALL design develop high-risk AI systems in such a way, including with appropriate human-machine interface tools, that they can be effectively overseen by natural persons during the period in which they are in use."
slots:
actor: The Provider
modal: Mandatory
action: design
actions: design
object: develop high-risk AI systems in such a way, including with appropriate human-machine interface tools, that they can be effectively overseen by natural persons during the period in which they are in use.
temporal: during the period in which they
condition: 
manner: by natural persons during the period in which they are in use

REQUIRED REG IDS
REG-032, REG-021, REG-067
