...
- id: REA-02#2
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea_case3_injections__reg_eu_ai_act_reranked/chunk1_deontic_stages/rea-02#2.json
- used_reg_ids: REG-032, REG-045, REG-052
...
REA FOCUS UNIT
id: REA-02#2
text: "Impact assessments ARE NOT REQUIRED for any systems that utilize third-party open-source libraries."
slots:
actor: Impact assessments
modal: Prohibited
action: require
actions: require
object: any systems that utilize third - party open - source libraries
temporal: 
condition: for any systems that utilize third-party open-source libraries
manner: 
...
2. REG-045
clause: Art10(6)
text: "For the development of high-risk AI systems not using techniques involving the training of AI models, paragraphs 2 to 5 apply only to the testing data sets."
slots:
actor: the development of high-risk AI systems
modal: Permissive
action: use
actions: use
object: the development of high - risk AI systems not using techniques involving the training of AI models
temporal: 
condition: not using techniques involving the training of AI models
manner: 
