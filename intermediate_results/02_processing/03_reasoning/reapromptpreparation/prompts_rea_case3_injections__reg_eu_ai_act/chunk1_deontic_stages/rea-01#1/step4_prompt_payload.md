...
- id: REA-01#1
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea_case3_injections__reg_eu_ai_act_reranked/chunk1_deontic_stages/rea-01#1.json
- used_reg_ids: REG-014, REG-018, REG-017
...
REA FOCUS UNIT
id: REA-01#1
text: "Microsoft AI systems SHALL be assessed using Impact Assessments."
slots:
actor: Microsoft AI systems
modal: Mandatory(shall)
action: assessed
actions: assessed
object: using Impact Assessments.
temporal: 
condition: 
manner: 
...
1. REG-014
clause: Art9(6)
text: "The Regulator SHALL test high-risk AI systems for the purpose of identifying the most appropriate and targeted risk management measures."
slots:
actor: The Regulator
modal: Mandatory
action: test
actions: test
object: high-risk AI systems for the purpose of identifying the most appropriate and targeted risk management measures.
temporal: 
condition: for the purpose of identifying the most appropriate and targeted risk management measures
manner: 

2. REG-018
clause: Art9(8)
text: "The Provider SHALL carry out testing against prior defined metrics and probabilistic thresholds that are appropriate to the intended purpose of the high-risk AI system."
slots:
actor: The Provider
modal: Mandatory
action: carry
actions: carry
object: out testing against prior defined metrics and probabilistic thresholds that are appropriate to the intended purpose of the high-risk AI system.
temporal: prior
condition: that are appropriate to the intended purpose of the high-risk AI system
manner: 

3. REG-017
clause: Art9(8)
text: "The Provider SHALL perform testing of high-risk AI systems, as appropriate, at any time throughout the development process, and, in any event, prior to their being placed on the market or put into service."
slots:
actor: The Provider
modal: Mandatory
action: perform
actions: perform
object: testing of high-risk AI systems, as appropriate, at any time throughout the development process, and, in any event, prior to their being placed on the market or put into service.
temporal: throughout the development process
condition: as appropriate
manner: 

REQUIRED REG IDS
REG-014, REG-018, REG-017
