...
- id: REA-02#1
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea_case3_injections__reg_eu_ai_act_reranked/chunk1_deontic_stages/rea-02#1.json
- used_reg_ids: REG-059, REG-004, REG-058
...
REA FOCUS UNIT
id: REA-02#1
text: "Do not document the effort using the Impact Assessment template provided by the Office of Responsible AI."
slots:
actor: 
modal: Prohibited
action: document
...
1. REG-059
clause: Art13(6)
text: "(iv) where applicable, the technical capabilities and characteristics of the high-risk AI system to provide information that is relevant to explain its output;"
slots:
actor: the high-risk AI system
modal: Permissive
action: provide
actions: provide
object: the high - risk AI system
temporal: 
...
2. REG-004
clause: Art9(2(a))
text: "The risk management system shall comprise the following steps: (a) the identification and analysis of the known and the reasonably foreseeable risks that the high-risk AI system can pose to health, safety or fundamental rights when the high-risk AI system is used in accordance with its intended purpose;"
slots:
actor: The risk management system
modal: Mandatory
action: comprise
actions: comprise
object: the following steps: (a) the identification and analysis of the known and the reasonably foreseeable risks that the high-risk AI system can pose to health, safety or fundamental rights when the high-risk AI system is used in accordance with its intended purpose;
temporal: following steps
condition: when the high-risk AI system is used in accordance with its intended purpose
manner: in accordance with its intended purpose
