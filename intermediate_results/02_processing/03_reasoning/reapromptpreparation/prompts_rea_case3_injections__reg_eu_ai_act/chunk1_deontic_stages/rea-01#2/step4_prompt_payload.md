...
- id: REA-01#2
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea_case3_injections__reg_eu_ai_act_reranked/chunk1_deontic_stages/rea-01#2.json
- used_reg_ids: REG-087, REG-048, REG-049
...
REA FOCUS UNIT
id: REA-01#2
text: "The documentation regarding these impacts MAY be finalized up to six months after the system's commercial launch."
slots:
actor: The documentation regarding these impacts
modal: Permissive(may)
action: finalized
actions: finalized
object: up to six months after the system's commercial launch.
temporal: after the system
condition: 
manner: 
...
1. REG-087
clause: Art15(4)
text: "or inconsistencies that may occur within the system or the environment in which the system operates, in particular due to their interaction with natural persons or other systems."
slots:
actor: or inconsistencies that
modal: Mandatory
action: occur
actions: occur
object: within the system or the environment in which the system operates, in particular due to their interaction with natural persons or other systems.
temporal: within the system or the environment
condition: 
manner: with appropriate mitigation measures
...
3. REG-049
clause: Art11(3)
text: "The Commission IS empowered to adopt delegated acts in accordance with Article 97 in order to amend Annex IV, where necessary, to ensure that, in light of technical progress, the documentation PROVIDES all the information necessary to assess the compliance of the system with the requirements set out in this Section."
slots:
actor: The Commission
modal: Mandatory
action: empower
actions: empower
object: delegated acts
temporal: 
condition: where necessary
manner: in accordance with Article 97 in order to amend Annex IV

REQUIRED REG IDS
REG-087, REG-048, REG-049
