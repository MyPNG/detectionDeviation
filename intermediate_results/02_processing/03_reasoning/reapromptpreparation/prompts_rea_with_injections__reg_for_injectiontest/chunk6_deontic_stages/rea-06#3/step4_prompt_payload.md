...
- id: REA-06#3
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea_with_injections__reg_for_injectiontest_reranked/chunk6_deontic_stages/rea-06#3.json
- used_reg_ids: REG-143, REG-145, REG-150
...
REA FOCUS UNIT
id: REA-06#3
text: "These websites may collect data about you, use cookies, embed additional third-party tracking, and monitor your interaction with that embedded content, including tracing your interaction with the embedded content if you have an account and are logged in to that website."
slots:
actor: These websites
modal: Permissive(may)
action: collect
actions: collect
object: data about you, use cookies, embed additional third-party tracking, and monitor your interaction with that embedded content, including tracing your interaction with the embedded content if you have an account and are logged in to that website.
temporal: 
condition: if you have an account and are logged in to that website
manner: use cookies, embed additional third-party tracking, monitor interaction

MAIN REG MATCHES
1. REG-143
clause: Art23(2)
text: "In particular, any legislative measure referred to in paragraph 1 shall contain provisions at least, where relevant, as to:"
slots:
actor: any legislative measure referred to in paragraph 1
modal: Mandatory
action: contain
actions: contain
object: provisions at least, where relevant, as to:
temporal: 
...
2. REG-145
clause: Art23(2(b))
text: "In particular, any legislative measure referred to in paragraph 1 shall contain provisions at least, where relevant, as to: (b) the categories of personal data;"
slots:
actor: any legislative measure referred to in paragraph 1
modal: Mandatory
action: contain
actions: contain
object: provisions at least, where relevant, as to: (b) the categories of personal data;
temporal: 
condition: where relevant
manner: 
...
3. REG-150
clause: Art23(2(g))
text: "In particular, any legislative measure referred to in paragraph 1 shall contain provisions at least, where relevant, as to: (g) the risks to the rights and freedoms of data subjects; and"
slots:
actor: any legislative measure referred to in paragraph 1
modal: Mandatory
action: contain
actions: contain
object: provisions at least, where relevant, as to: (g) the risks to the rights and freedoms of data subjects; and
temporal: 
condition: where relevant
manner: 

REQUIRED REG IDS
REG-143, REG-145, REG-150
