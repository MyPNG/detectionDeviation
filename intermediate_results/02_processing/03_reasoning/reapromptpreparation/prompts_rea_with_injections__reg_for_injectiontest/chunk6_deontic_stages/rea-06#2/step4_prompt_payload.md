...
- id: REA-06#2
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea_with_injections__reg_for_injectiontest_reranked/chunk6_deontic_stages/rea-06#2.json
- used_reg_ids: REG-057, REG-028, REG-023
...
action: apply
actions: apply
object: if one of the following applies:
temporal: following applies
condition: if one of the following applies
manner: 

REQUIRED REG IDS
REG-057, REG-028, REG-023
