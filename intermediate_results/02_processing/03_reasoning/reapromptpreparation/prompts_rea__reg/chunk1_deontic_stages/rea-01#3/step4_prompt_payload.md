...
- id: REA-01#3
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea__reg_reranked/chunk1_deontic_stages/rea-01#3.json
- used_reg_ids: REG-057, REG-034, REG-073
...
REA FOCUS UNIT
id: REA-01#3
text: "The provision of information is free of charge for you."
slots:
actor: The provision of information
modal: Permissive
action: receive
actions: 
object: information
...
3. REG-073
clause: Art15(3)
text: "Where the Data Subject makes the request by electronic means, and unless otherwise requested, The Controller SHALL provide the information in a commonly used electronic form."
slots:
actor: The Controller
modal: Mandatory
action: provide
actions: provide
object: the information in a commonly used electronic form.
temporal: by electronic means
condition: Where the Data Subject makes the request by electronic means
manner: by electronic means

REQUIRED REG IDS
REG-057, REG-034, REG-073
