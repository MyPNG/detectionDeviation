...
- id: REA-01#4
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea__reg_reranked/chunk1_deontic_stages/rea-01#4.json
- used_reg_ids: REG-059, REG-065, REG-052
...
REA FOCUS UNIT
id: REA-01#4
text: "The right to information does not exist or is subject to limitations if and to the extent that confidential information, such as information that is subject to professional secrecy, would be disclosed."
slots:
actor: The right to information
modal: Prohibited
action: exist
actions: exist
object: information
temporal: 
condition: if and to the extent that confidential information
manner: 

MAIN REG MATCHES
1. REG-059
clause: Art14(5(d))
text: "Paragraphs 1 to 4 shall not apply where and insofar as: (d) where the personal data must remain subject to an obligation of professional secrecy regulated by Union or Member State law, including a statutory obligation of secrecy."
slots:
actor: Paragraphs 1 to 4
modal: Prohibited
action: apply
actions: apply
object: where and insofar as: (d) where the personal data must remain subject to an obligation of professional secrecy regulated by Union or Member State law, including a statutory obligation of secrecy.
temporal: by Union or Member State law
condition: where and insofar as
manner: by Union or Member State law
