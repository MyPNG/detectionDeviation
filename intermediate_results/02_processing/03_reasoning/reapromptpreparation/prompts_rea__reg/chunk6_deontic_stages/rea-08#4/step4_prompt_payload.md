...
- id: REA-08#4
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea__reg_reranked/chunk6_deontic_stages/rea-08#4.json
- used_reg_ids: REG-003, REG-064, REG-104
...
REA FOCUS UNIT
id: REA-08#4
text: "GDPR is the legal basis for the data transfer. If there is a legal obligation to disclose the data, the legal basis for the data transfer is Art 6 para 1 lit c) GDPR. If, on the other hand, the disclosure is necessary for the fulfilment of a contractual or pre-contractual measure with you as a natural person, Art 6 para 1 lit b)"
slots:
actor: GDPR
modal: is
action: be
actions: be
object: the data transfer
temporal: 
condition: If there is a legal obligation to disclose the data
manner: 
...
temporal: 
condition: where
manner: structured, commonly used and machine-readable format

REQUIRED REG IDS
REG-003, REG-064, REG-104
