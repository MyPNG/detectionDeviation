...
- id: REA-08#6
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea__reg_reranked/chunk6_deontic_stages/rea-08#6.json
- used_reg_ids: REG-022, REG-043, REG-007
...
REA FOCUS UNIT
id: REA-08#6
text: "Otherwise, the transfer is based on our legitimate interests and the legal basis is Art 6 para 1 lit f) GDPR."
slots:
actor: the transfer
modal: transfer is based on
action: base
actions: base
object: our legitimate interests and the legal basis
temporal: 
condition: Otherwise
manner: 
