...
- id: REA-04#3
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea__reg_reranked/chunk4_deontic_stages/rea-04#3.json
- used_reg_ids: REG-101, REG-064, REG-003
...
REA FOCUS UNIT
id: REA-04#3
text: "You are required to transfer data in order to fulfil the processing purposes listed below, and this may include transferring data to third parties."
slots:
actor: and this
modal: Permissive(may)
action: include
actions: include
object: transferring data to third parties.
temporal: 
condition: 
manner: 
...
action: be lawful
actions: be lawful
object: only if and to the extent that at least one of the following applies: (b) processing is necessary for the performance of a contract to which the data subject is party or in order to take steps at the request of the data subject prior to entering into a contract;
temporal: following applies
condition: if and to the extent that at least one of the following applies
manner: 

REQUIRED REG IDS
REG-101, REG-064, REG-003
