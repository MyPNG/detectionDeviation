...
- id: REA-03#1
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea__reg_reranked/chunk2_deontic_stages/rea-03#1.json
- used_reg_ids: REG-080, REG-078, REG-077
...
REA FOCUS UNIT
id: REA-03#1
text: "You have the right to request that we erase your personal data if and to the extent that the data is no longer needed for the purposes for which it was collected or, if the processing is based on your consent, you have withdrawn your consent."
slots:
actor: You
modal: Mandatory
action: have
actions: have
object: the right to request that we erase your personal data if and to the extent that the data is no longer needed for the purposes for which it was collected or , if the processing is based on your consent , you have withdrawn your consent
temporal: 
condition: if and to the extent that the data is no longer needed for the purposes for which it was collected or
manner: 
...
2. REG-078
clause: Art17(1(a))
text: "the controller shall have the obligation to erase personal data without undue delay where one of the following grounds applies: (a) the personal data are no longer necessary in relation to the purposes for which they were collected or otherwise processed;."
slots:
actor: the controller
modal: Obligation
action: have
actions: have
object: the obligation to erase personal data without undue delay where one of the following grounds applies: (a) the personal data are no longer necessary in relation to the purposes for which they were collected or otherwise processed;.
temporal: following grounds applies
condition: where one of the following grounds applies
manner: 
