...
- id: REA-04#1
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea__reg_reranked/chunk2_deontic_stages/rea-04#1.json
- used_reg_ids: REG-086, REG-108, REG-004
...
REA FOCUS UNIT
id: REA-04#1
text: "A right to erasure does not exist insofar as the data may not be deleted due to a legal obligation or you must process the data due to a legal obligation"
slots:
actor: A right to erasure does not exist insofar as the data
modal: Prohibited(may not)
action: delete
actions: delete
object: due to a legal obligation or you must process the data due to a legal obligation
temporal: 
condition: 
manner: 
...
1. REG-086
clause: Art17(1(e))
text: "the controller shall have the obligation to erase personal data without undue delay where one of the following grounds applies: (e) the personal data have to be erased for compliance with a legal obligation in Union or Member State law to which the controller is subject;."
slots:
actor: the controller
modal: 
action: have
actions: have
object: the obligation to erase personal data without undue delay where one of the following grounds applies: (e) the personal data have to be erased for compliance with a legal obligation in Union or Member State law to which the controller is subject;.
...
2. REG-108
clause: Art20(3)
text: "That right shall not apply to processing necessary for the performance of a task carried out in the public interest or in the exercise of official authority vested in the controller."
slots:
actor: That right
modal: Prohibited
action: apply
actions: apply
object: to processing necessary for the performance of a task carried out in the public interest or in the exercise of official authority vested in the controller.
temporal: 
condition: necessary for the performance of a task carried out in the public interest or in the exercise of official authority
manner: 
...
action: be lawful
actions: be lawful
object: only if and to the extent that at least one of the following applies: (c) processing is necessary for compliance with a legal obligation to which the controller is subject;
temporal: following applies
condition: if and to the extent that at least one of the following applies
manner: 

REQUIRED REG IDS
REG-086, REG-108, REG-004
