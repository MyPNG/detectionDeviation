...
- id: REA-05#1
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea__reg_reranked/chunk5_deontic_stages/rea-05#1.json
- used_reg_ids: REG-064, REG-023, REG-122
...
REA FOCUS UNIT
id: REA-05#1
text: "We share your data with service providers bound by instructions, both within the PwC network and with other third parties, such as IT service providers, who support us in our activities, e.g. as part of the administration and maintenance of the websites and the related systems and/or for other internal or administrative purposes."
slots:
actor: We
modal: Permissive
action: share
actions: share
object: your data with service providers bound by instructions
temporal: within the PwC network and with
condition: 
...
2. REG-023
clause: Art13(1(e))
text: "The Controller SHALL provide the data subject with all of the following information: (e) the recipients or categories of recipients of the personal data, if any,"
slots:
actor: The Controller
modal: Mandatory
action: provide
actions: provide
object: the data subject with all of the following information: (e) the recipients or categories of recipients of the personal data, if any,
