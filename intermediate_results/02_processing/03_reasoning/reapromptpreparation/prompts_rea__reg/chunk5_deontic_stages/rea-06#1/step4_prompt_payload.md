...
- id: REA-06#1
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea__reg_reranked/chunk5_deontic_stages/rea-06#1.json
- used_reg_ids: REG-037, REG-021, REG-004
...
REA FOCUS UNIT
id: REA-06#1
text: "If we pass on data to service providers bound by instructions, we do not require a separate legal basis for this."
slots:
actor: we
modal: Permissive
action: pass
actions: pass
object: data to service providers bound by instructions
temporal: by instructions
condition: If we pass on data to service providers bound by instructions
manner: by instructions
