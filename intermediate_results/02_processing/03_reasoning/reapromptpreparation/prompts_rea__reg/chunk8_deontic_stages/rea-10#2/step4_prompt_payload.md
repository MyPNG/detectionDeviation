...
- id: REA-10#2
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea__reg_reranked/chunk8_deontic_stages/rea-10#2.json
- used_reg_ids: REG-101, REG-026, REG-042
...
REA FOCUS UNIT
id: REA-10#2
text: "The Data Processor will store the aforementioned data for 7 days and then delete it."
slots:
actor: The Data Processor
modal: Mandatory(will)
action: store
actions: store
object: the aforementioned data for 7 days and then delete it.
temporal: then delete it
condition: 
manner: 
...
2. REG-026
clause: Art13(2(a))
text: "The controller SHALL provide the data subject with the following further information necessary to ensure fair and transparent processing: (a) the period for which the personal data will be stored, or if that is not possible, the criteria used to determine that period;"
slots:
actor: The controller
modal: Mandatory
action: provide
actions: provide
object: the data subject with the following further information necessary to ensure fair and transparent processing: (a) the period for which the personal data will be stored, or if that is not possible, the criteria used to determine that period;
