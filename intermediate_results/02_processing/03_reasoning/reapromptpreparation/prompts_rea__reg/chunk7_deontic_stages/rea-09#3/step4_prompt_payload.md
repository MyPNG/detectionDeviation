...
- id: REA-09#3
- top_k: 3
- reranked_json: /Users/my/Documents/projects/detectionDeviation/intermediate_results/02_processing/01_retrieval/reranker/artifact_01_rea__reg_reranked/chunk7_deontic_stages/rea-09#3.json
- used_reg_ids: REG-071, REG-038, REG-076
...
REA FOCUS UNIT
id: REA-09#3
text: "This involves the following personal data which is automatically transmitted to our server by your browser IP address."
slots:
actor: your browser
modal: Mandatory
action: involve
actions: involve
object: the following personal data which is automatically transmitted to our server by your browser IP address
temporal: following personal data which is automatically
condition: 
manner: by your browser IP address
